...
class nmf_np:
    ...
    def compute_MSE(self,M,R,R_pred):
        ...
        # print R_pred
        # print "********"
        return math.sqrt ((M * (R-R_pred)**2).sum() / float(M.sum()))
    ...
    def give_update(self,iteration):    
        ...
        print "Iteration %s. I-divergence: %s. RMSE: %s. R^2: %s. Rp: %s." % (iteration,i_div,perf['MSE'],perf['R^2'],perf['Rp'])
