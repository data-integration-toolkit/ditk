...
def process_data(dataset,config):
    ...
    # build char dict
    train_data = load_dataset(dataset["train"], config["task_name"], keep_number=True,
                              lowercase=config["char_lowercase"])
    dev_data = load_dataset(dataset["dev"], config["task_name"], keep_number=True,
                            lowercase=config["char_lowercase"])
    test_data = load_dataset(dataset["test"], config["task_name"], keep_number=True,
                             lowercase=config["char_lowercase"])
