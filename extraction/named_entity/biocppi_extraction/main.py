...
def main(inputFilePath):
    ...
    test_params = {'num_ensembles':2,'num_iterations':500,'num_it_per_ckpt':100}  # note, it num_it_per_ckpt > num_iterations then num_it_per_ckpt will be set to half of num_iterations
