...
def writefile(sentences, filedir, filename, sep='\t'):
    ...
    with codecs.open(WRITEFILE,'w+',encoding='utf-8') as fd:
...
# TRAIN, TEST = write_new_split('Wikigold', 690, 'C:/Users/kkuna/PycharmProjects/transfer-learning-ner/data/wikigold', 'nist', max_count = 2)