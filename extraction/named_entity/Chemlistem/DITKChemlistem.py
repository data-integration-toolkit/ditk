...
class DITKChemlistem(Ner):
    ...
    def save_model():
        #This method is unused since it automatically saves after training (and while training)
        pass
    def load_model():
        #This method is unused since it automatically loads the model before prediction
        pass
