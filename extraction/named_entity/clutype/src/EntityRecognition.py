...
def run(segment_path, ground_truth_path, type_path, K, annotation_path, annotationInText_path):
    ### Parameter setting #############################################################
    ...
    mention_graph_path = top_dir + 'temp/temp_gc/W_M.txt'
    ...
    final_predictions = write_output(annotation_path, Y, doc_mid, mid_mention, tid_type)
