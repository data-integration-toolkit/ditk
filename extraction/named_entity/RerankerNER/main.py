...
if __name__ == '__main__':
	...
	if len(sys.argv) > 4:
		main(train_file, dev_file, test_file, embedding_file, sys.argv[1], sys.argv[2], sys.argv[3], int(sys.argv[4]))
	elif len(sys.argv) == 4:
		main(train_file, dev_file, test_file, embedding_file, sys.argv[1], sys.argv[2], sys.argv[3])
	else:
		main(train_file, dev_file, test_file, embedding_file, sys.argv[1],"NORMAL", "A")
