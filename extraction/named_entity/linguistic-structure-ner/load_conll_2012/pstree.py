...
class PSTree():
	...
	# >>> tree = tree_from_text("(ROOT (S (NP (NP (DT The) (JJ fifth) (NN line)) (PP (IN of) (NP (NP (DT the) (NN chorus)) (: :) (`` ``) (NP (NP (NNP Contra) (NNP os) (NNS canhões) (NN marchar)) (, ,) (NP (NN marchar))) ('' '') (PRN (-LRB- -LRB-) (PP (IN Against) (NP (DT the) (JJ cannons) (NN march))) (, ,) (NP (NN march) (. !)) (-RRB- -RRB-))))) (VP (VBZ is) (NP (NP (DT an) (NN alteration)) (PP (IN of) (NP (NP (NP (DT the) (JJ original) (`` ``) (NNP Contra) (NN os) (NNS bretões) (NN marchar)) (, ,) (NP (NN marchar) ('' '')) (PRN (-LRB- -LRB-) (PP (IN Against) (NP (DT the) (NNP Britos) (NN march))) (, ,) (NP (NN march) (. !)) (-RRB- -RRB-))) (, ,) (NP (NP (DT a) (NN reference)) (PP (TO to) (NP (DT the) (NNP Pink) (NNP Map)))))))) (. .)))")
	# >>> print(tree)
