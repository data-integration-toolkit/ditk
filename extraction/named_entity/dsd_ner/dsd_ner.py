#Python code for "Learning Named Entity Tagger using Domain-Specific Dictionary"

#Using word embeddings instead of dictionaries
#
...
from preprocess import processData,createBatches,createMatrices, createMatricesPrediction, iterate_minibatches,addCharInformation,padding, getCasing
...
class DSD_ner(Ner):
    ...
    def load_embeddings(self):
        ...
        fEmbeddings = open("./data/embeddings/glove.6B.50d.txt", encoding="utf-8")
