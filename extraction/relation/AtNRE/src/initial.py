...
def init_batchdata(vec_dir):
    ...
    with open(AtNRE_dir +'/data/dict_entityname2id.pkl','rb') as input:
        dict_entityname2id = pickle.load(input)


    print('reading relation to id')
    relation2id = {}
    f = open(AtNRE_dir +'/origin_data/relation2id.txt', 'r', encoding='utf-8')
    while True:
        content = f.readline()
        if content == '':
            break
    ...
    f = open(AtNRE_dir +'/origin_data/train.txt', 'r', encoding='utf-8')
    ...
    f = open(AtNRE_dir +'/origin_data/test.txt', 'r', encoding='utf-8')
    count = 0
    while True:
        content = f.readline()
        if content == '':
    ...
    np.save(AtNRE_dir +'/data/vec.npy', vec)
    np.save(AtNRE_dir +'/data/train_x.npy', train_x)
    np.save(AtNRE_dir +'/data/train_y.npy', train_y)
    np.save(AtNRE_dir +'/data/testall_x.npy', test_x)
    np.save(AtNRE_dir +'/data/testall_y.npy', test_y)
    np.save(AtNRE_dir +'/data/train_entitypair',train_entitypair)
...
def seperate():
    ...
    x_train = np.load(AtNRE_dir +'/data/train_x.npy')
    ...
    np.save(AtNRE_dir +'/data/train_word.npy', train_word)
    np.save(AtNRE_dir +'/data/train_pos1.npy', train_pos1)
    np.save(AtNRE_dir +'/data/train_pos2.npy', train_pos2)

    #print (len(train_word))


    print('seperating test data')
    x_test = np.load(AtNRE_dir +'/data/testall_x.npy')
    test_word = []
    test_pos1 = []
    test_pos2 = []
    ...
    np.save(AtNRE_dir +'/data/testall_word.npy', test_word)
    np.save(AtNRE_dir +'/data/testall_pos1.npy', test_pos1)
    np.save(AtNRE_dir +'/data/testall_pos2.npy', test_pos2)
    return 1



def init_entityebd(train_dir):

    dict_entityname2id = {}
    print('Reading train data...')
    f = open(train_dir, 'r', encoding='utf-8')
    ...
    with open(AtNRE_dir +'/data/dict_entityname2id.pkl','wb') as output:
...
def init_cnndata():
    ...
    y_train = np.load(AtNRE_dir +'/data/train_y.npy')

    train_word = np.load(AtNRE_dir +'/data/train_word.npy')
    train_pos1 = np.load(AtNRE_dir +'/data/train_pos1.npy')
    train_pos2 = np.load(AtNRE_dir +'/data/train_pos2.npy')

    y_test = np.load(AtNRE_dir +'/data/testall_y.npy')
    ...
    np.save(AtNRE_dir +'/cnndata/cnn_train_word.npy', cnn_train_word)
    np.save(AtNRE_dir +'/cnndata/cnn_train_pos1.npy', cnn_train_pos1)
    np.save(AtNRE_dir +'/cnndata/cnn_train_pos2.npy', cnn_train_pos2)
    np.save(AtNRE_dir +'/cnndata/cnn_train_y.npy', cnn_train_y)

    np.save(AtNRE_dir +'/cnndata/cnn_test_word.npy', cnn_test_word)
    np.save(AtNRE_dir +'/cnndata/cnn_test_pos1.npy', cnn_test_pos1)
    np.save(AtNRE_dir +'/cnndata/cnn_test_pos2.npy', cnn_test_pos2)
    np.save(AtNRE_dir +'/cnndata/cnn_test_y.npy', cnn_test_y)
