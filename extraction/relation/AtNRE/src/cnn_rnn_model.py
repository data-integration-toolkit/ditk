...
def train(path_train_word,path_train_pos1,path_train_pos2,path_train_y,save_path):
    ...
    wordembedding = np.load(AtNRE_dir +'/data/vec.npy')
...
class interaction():
    ...
    def __init__(self,sess,save_path =AtNRE_dir +'/model/model.ckpt3'):
        ...
        self.train_word = np.load(AtNRE_dir +'/data/train_word.npy')
        self.train_pos1 = np.load(AtNRE_dir +'/data/train_pos1.npy')
        self.train_pos2 = np.load(AtNRE_dir +'/data/train_pos2.npy')
        self.y_train = np.load(AtNRE_dir +'/data/train_y.npy')
