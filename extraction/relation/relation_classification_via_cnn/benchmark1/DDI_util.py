...
def readData(inputfiles, type, output_dir):
    input_dir = []
    for filepath in inputfiles:
        input_dir.append(filepath)

    if type == "train":
        file_name = output_dir+'\\relation_extraction_input_train.txt'
    else:
        file_name = output_dir+'\\relation_extraction_input_test.txt'
...
inputfiles=[dir_path+'\\Train\\MedLine\\', dir_path+'\\Train\\DrugBank\\']
readData(inputfiles, "train", dir_path)
inputfiles=[dir_path+'\\Test\\MedLine\\', dir_path+'\\Test\\DrugBank\\']
readData(inputfiles, "test", dir_path)