...
class CNN_Relation(object):		 
	def __init__(self, seq_len, num_classes, vocab_size, pos_dict_size, p1_dict_size, p2_dict_size, type_dict_size, 
		w_emb_size, p1_emb_size, p2_emb_size, pos_emb_size, type_emb_size, filter_sizes, num_filters, l2_reg_lambda = 0.0):
		...
		X = tf.concat([emb, emb1, emb2, emb3, emb4], 2)			#shape(?, 21, 100)
		...
		self.losses = tf.nn.softmax_cross_entropy_with_logits_v2(scores, self.input_y)
