...
def readData(inputfiles,type):
    input_dir = []
    for filepath in inputfiles:
        input_dir.append(filepath)
    if type == "train":
        tr_data = read(input_dir)
        fw = open('/Users/sonaligujarathi/Documents/Integration Web/Project/AttentionBasedBiLSTM/data/DDI 2013/common_ddi_input_test.txt', 'w')
...
inputfiles=["/Users/sonaligujarathi/Documents/Integration Web/Project/AttentionBasedBiLSTM/data/DDI 2013/Test/MedLine", "/Users/sonaligujarathi/Documents/Integration Web/Project/AttentionBasedBiLSTM/data/DDI 2013/Test/DrugBank"]
readData(inputfiles,"train")