import numpy as np
from graph.embedding.HolE.skge.base import Model
from graph.embedding.HolE.skge.util import grad_sum_matrix, unzip_triples, ccorr, cconv
from graph.embedding.HolE.skge.param import normless1
import graph.embedding.HolE.skge.actfun as af
...
class HolE(Model):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.add_hyperparam('af', af.Sigmoid)
