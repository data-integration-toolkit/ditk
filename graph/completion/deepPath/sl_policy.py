...
graphpath = None #dataPath + 'tasks/' + relation + '/' + 'graph.txt'
relationPath = None #dataPath + 'tasks/' + relation + '/' + 'train_pos'
...
def setup(rel, path) :
	...
	graphpath = path + '/tasks/' + relation + '/graph.txt'
	relationPath = path + '/tasks/' + relation + '/train_pos'
...
def train(relation_option = None):
	if relation_option != None :
		relation = relation_option
