        ...
        for batch in xrange(self.data.num_batch_test):
            ...
            for i, (q, h, t) in enumerate(zip(qq, hh, tt)):
                ...
                if self.option.query_is_language:
                    ...
                    #print final predicted tuples
                    # print h_string, q_string, t_string
                    sentence = h_string+" "+q_string+" "+t_string
                    output_file_obj.write(sentence+"\n")
          
                    #print "output written to output file"
