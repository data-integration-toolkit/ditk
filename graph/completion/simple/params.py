...
class Params:
	...
	def get_early_stopping_itrs(self):
		...
		return self.es_itrs
	def __str__(self):
		string = "self.learning_rate " + str(self.learning_rate) + "\n"
		string += "self.gamma " + str(self.gamma) + "\n"
		string += "self.batch_size " + str(self.batch_size) + "\n"
		string += "self.max_iterate " + str(self.max_iterate) + "\n"
		string += "self.p_norm " + str(self.p_norm) + "\n"
		string += "self.emb_size " + str(self.emb_size) + "\n"
		string += "self.alpha " + str(self.alpha) + "\n"
		string += "self.neg_ratio " + str(self.neg_ratio) + "\n"
		string += "self.save_each " + str(self.save_each) + "\n"
		string += "self.save_after " + str(self.save_after)
