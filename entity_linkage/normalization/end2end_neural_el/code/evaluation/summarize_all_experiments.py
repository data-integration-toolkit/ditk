...
def evaluation_main_modified(base_folder, dev_set, test_set):

    parser = argparse.ArgumentParser()
    parser.add_argument("--base_folder", default=base_folder)
    parser.add_argument("--macro_or_micro", default="macro")
    parser.add_argument("--dev_set", default=dev_set)
    parser.add_argument("--test_set", default=test_set)
