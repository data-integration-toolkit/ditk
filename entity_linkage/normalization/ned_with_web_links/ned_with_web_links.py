...
class EntityNormalization(abc.ABC):
    ...
    def read_dataset(cls, dataset_name, split_ratio, *args):
        ...
        train_num = count*split_ratio[0]
        eval_num = count*split_ratio[1]
        test_num = count - train_num - eval_num

        return docs.takeSample(False, train_num), docs.takeSample(False, eval_num), docs.takeSample(False, test_num)
