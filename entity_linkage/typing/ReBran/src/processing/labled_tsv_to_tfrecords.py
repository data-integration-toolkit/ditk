...
#data/cdr/processed/just_train_2500/\*tive_\*CDR\*

tf.app.flags.DEFINE_string('kg_in_files', '', 'pattern to match kg input files')
tf.app.flags.DEFINE_string('text_in_files', 'data/cdr/processed/just_train_2500/*tive_*CDR*', 'pattern to match text input files')
tf.app.flags.DEFINE_string('out_dir', 'data/cdr/processed/just_train_2500/protos', 'export tf protos')
tf.app.flags.DEFINE_string('load_vocab', '', 'directory containing vocab files to load')
tf.app.flags.DEFINE_integer('max_len', 500000, 'maximum sequence length')
tf.app.flags.DEFINE_integer('min_count', 5, 'replace tokens occuring less than this many times with <UNK>')
tf.app.flags.DEFINE_integer('num_threads', 10, 'max number of threads to use for parallel processing')
...
tf.app.flags.DEFINE_boolean('multiple_mentions', True, 'consider all mentions of e1 and e2')
tf.app.flags.DEFINE_boolean('tsv_format', True, 'data in 13 column tsv format')
