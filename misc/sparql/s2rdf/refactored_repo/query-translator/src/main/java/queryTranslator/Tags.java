...
public final class Tags {
	...
	public static String VP_TABLE_STAT= SPARK_STATISTIC_DIRECTORY + "/stat_vp.csv";
	public static String SO_TABLE_STAT= SPARK_STATISTIC_DIRECTORY + "/stat_so.csv";
	public static String OS_TABLE_STAT= SPARK_STATISTIC_DIRECTORY + "/stat_os.csv";
	public static String SS_TABLE_STAT= SPARK_STATISTIC_DIRECTORY + "/stat_ss.csv";
