...
def main(fileName):
    ...
    # Returns Pearson Convertrelation Coefficient and Spearman Correlation Coefficient
...
if __name__ == '__main__':
    output_file_path = main('C:/Users/malla/OneDrive/Documents/548ProjectCode/Word2Vec/Datasets/') # Path where the datasets have been saved