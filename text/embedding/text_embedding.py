...
class TextEmbedding(abc.ABC):
	...
	@abc.abstractmethod
	def read_dataset(self, name, file_name):
		"""
		...
		file_name -- string -- Directory Path to the dataset
		return:
	...
	def read_cornell_movie_dataset(self, file_name):
		"""
	...
	def read_categorical_dataset(self, file_name):
		"""
	...
	def read_conll2003_dataset(self, file_name):
		"""
	...
	def read_semeval_sick_dataset(self, file_name):
		"""
